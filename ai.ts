...
// NOTA: con `output: 'export'` (static export) no hay servidor, así que
// process.env.OPENAI_API_KEY NO se inyecta en el cliente y el motor real
// es siempre `fallbackResponse`. Si en el futuro quieres IA real, hazlo
// vía una API route en un deploy con servidor (no static export) para no
